...
parser = argparse.ArgumentParser(description='Generate nico image with your favorite book')
parser.add_argument('book', metavar='book', type=str, nargs=1, help='cover image. Optimal aspect ratio is ~1.35')
parser.add_argument('out', metavar='out', nargs='?', help='output image with embeded book')
